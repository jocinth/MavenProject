...
formatter.step({
  "name": "User wants to give valid usernam and passwor using DataTable with header Two-D, and click on the login button",
  "rows": [
    {
      "cells": [
        "UserName",
...
formatter.match({
  "location": "StepDefinitions.user_wants_to_give_valid_usernam_and_passwor_using_DataTable_with_header_Two_D_and_click_on_the_login_button(DataTable)"
});
formatter.result({
  "status": "passed"
});
